 ...
 */
final class Version20220629205948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD gestionnaire_id INT DEFAULT NULL, ADD client_id INT DEFAULT NULL, ADD livraison_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP gestionnaire_id, DROP client_id, DROP livraison_id');
